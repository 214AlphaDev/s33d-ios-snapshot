...
class ChatTextMessageCell: UITableViewCell {
    ...
    var chatMessage : TextMessage! {
        didSet{
            ...
            DispatchQueue.main.async {  [weak self] in
                ...
                // Disable text message read receipts instead of removing them to maintain proper UI
                // Can be re-enabled once additional features are added by deleting the line below
                strongSelf.readRecipts.isHidden = true
            }
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?){
        ...
        // Disable msg timestamps instead of removing them to maintain proper UI
        // Can be re-enabled once additional features are added by deleting the line below
