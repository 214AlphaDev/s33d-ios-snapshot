...
class UserProfileViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    func handleProfileItems()
    {
        if isDisplayType == "OneOneOneViewProfile"{
            //Disable the UserProfileCells for audio and video call until the functionality is implemented
            ...
            //Disable the UserProfileCells for group management until the functionality is implemented
