...
class CCTabBarController: UITabBarController,UITabBarControllerDelegate {
    ...
    var tab1:FeedPlaceholderScreen!
    ...
    func handleViewControllers(){
        ...
        //let recentIcon = UITabBarItem(title: NSLocalizedString("Feed", comment: ""), image: UIImage(named: "recent.png"), selectedImage: UIImage(named: "recent.png"))
        
        let contactIcon = UITabBarItem(title: NSLocalizedString(Contants.chatTabBarTitle, comment: ""), image: UIImage(named: "contact.png"), selectedImage: UIImage(named: "contact.png"))
